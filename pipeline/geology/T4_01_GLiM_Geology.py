...
GDB_PATH_CANDIDATES = [
    BASE_DIR / "data" / "raw" / "LiMW_GIS 2015.gdb",
]
GDB_PATH      = next((p for p in GDB_PATH_CANDIDATES if p.exists()), GDB_PATH_CANDIDATES[0])
PROCESSED_DIR = BASE_DIR / "data" / "processed"
OUTPUT_DIR    = BASE_DIR / "data" / "outputs"
CLIPPED_OUT   = PROCESSED_DIR / "glim_study_area.gpkg"
SUMMARY_OUT   = PROCESSED_DIR / "rock_type_summary.csv"
